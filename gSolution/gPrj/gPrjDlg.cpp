...
BEGIN_MESSAGE_MAP(CgPrjDlg, CDialogEx)
	...
	ON_BN_CLICKED(IDC_THREAD, &CgPrjDlg::OnBnClickedThread)
END_MESSAGE_MAP()
...
BOOL CgPrjDlg::OnInitDialog()
{
	...
	m_pDlgImgResult->MoveWindow(640, 640, 640, 480);
...
void CgPrjDlg::OnBnClickedBtnMakePattern()
{
	...
	for (int j = rect.top; j < rect.bottom; j++) {
		for(int i = rect.left; rect.right; i++) {
...
void CgPrjDlg::OnBnClickedThread()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
